var fileshareApp = angular.module("fileShareApp", [ "ngRoute","ngGrid" ]).config(
...
//		    };
  ...
  $scope.DeleteContact = function(id) {
	   $http.delete('/resource/delete', {params: {'id': id}}).then(contactdeleteSuccessMsg)
  ...
  function contactdeleteError(response) {
	...
	$scope.gridOptions = {
		    ...
		    columnDefs: [
		      { field: 'id', displayName:"Contact Id",cellClass: 'ui-grid-align' },
		      ...
		      { field: 'delete', enableSorting: false, cellTemplate: '<button id="deleteBtn" type="button"  ng-click="DeleteContact(row.entity.id)" >Delete</button>' }
